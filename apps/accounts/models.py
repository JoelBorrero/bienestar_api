...
class Activity(BaseModel):
    ...
    guests_info = models.CharField('Información de invitados', max_length=503, blank=True)
    local_guests = models.PositiveSmallIntegerField('Invitados locales', default=0)
    national_guests = models.PositiveSmallIntegerField('Invitados nacionales', default=0)
    international_guests = models.PositiveSmallIntegerField('Invitados internacionales', default=0)

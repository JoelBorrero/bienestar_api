...
class Activity(BaseModel):
    ...
    group = models.ForeignKey(
        Group, verbose_name='Grupo', on_delete=models.CASCADE)
    ...
    category = models.CharField(
        'Categoría', max_length=3, choices=ACTIVITY_CATEGORIES)
    is_virtual = models.BooleanField('Es virtual')
    institutional = models.CharField(
        'Institucional', max_length=51, blank=True)
    ...
    local_guests = models.PositiveSmallIntegerField(
        'Invitados locales', default=0)
    ...
    status = models.CharField('Estado', max_length=1,
                              choices=ACTIVITY_STATUSES)
